<template>
  ...
  >
    ...
    <div
      class="trezo-card-content relative h-[140px] lg:h-[245px] xl:h-[140px]"
    >
      ...
      <div
        class="left-0 right-0 -bottom-[53px] md:-bottom-[61px] absolute ltr:-ml-[32px] rtl:-mr-[32px] ltr:-mr-[30px] rtl:-ml-[30px] md:ltr:-ml-[37px] md:rtl:-mr-[37px] md:ltr:-mr-[35px] md:rtl:-ml-[35px]"
      >
        <apexchart
          v-if="isClient"
          type="area"
