  ...
  >
    <div class="trezo-card-header mb-[20px] md:mb-[25px] flex justify-between">
      <div class="trezo-card-title">
        <h5 class="!mb-px !font-semibold">Outbound Calls</h5>
        <p class="text-xs">Summary of outgoing call efforts</p>
      </div>
      ...
      <div class="flex items-center gap-[30px]">
        <div class="flex items-center gap-[15px]">
          ...
          <div>
            ...
            <span class="block"> Last month </span>
          </div>
        </div>
        <span
        ...
        >
          <i
            class="material-symbols-outlined absolute ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 text-danger-600 !text-[20px]"
          >
            trending_down
          </i>
          -5.8%
