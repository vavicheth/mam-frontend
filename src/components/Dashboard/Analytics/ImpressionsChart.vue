<template>
  ...
  >
    <div class="trezo-card-content relative">
      <span class="block mb-[5px]"> Impressions </span>
      <div class="flex items-center">
        <h6 class="!mb-0 !text-[20px]">12,000</h6>
        <span
        ...
        >
          <i
            class="ri-arrow-down-s-fill absolute ltr:left-[2px] rtl:right-[2px] text-[22px] top-1/2 -translate-y-1/2"
          ></i>
          10.5%
        </span>
      </div>
