  ...
  <form>
    ...
    >
      <div class="trezo-card-content">
        <div class="sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-[25px]">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[25px] my-[25px]">
          <div
            class="relative rounded-md p-[20px] md:p-[25px] min-h-[189px] border border-gray-100 dark:border-[#172036]"
          >
            <span
              class="block font-medium text-black dark:text-white mb-[20px]"
            >
              From:
            </span>
            ...
            <span class="block mb-[4px] last:mb-0"> olivia@trezo.com </span>
            <span class="block mb-[4px] last:mb-0">
              4545 Seth Street Ballinger, TX 78965
            </span>
            <span class="block mb-[4px] last:mb-0"> +1 444 556 8899 </span>
            <button
              type="button"
              class="inline-block transition-all font-medium border border-dashed border-primary-500 py-[4px] px-[10px] rounded-md text-sm text-primary-500 hover:bg-primary-500 hover:text-white absolute top-[20px] md:top-[25px] ltr:right-[20px] rtl:left-[20px] ltr:md:right-[25px] rtl:md:left-[25px]"
            >
            ...
            <tbody class="text-black dark:text-white">
              <tr>
                ...
                >
                  <input
                    type="text"
                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-[200px] outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
              ...
              <tr>
                ...
                >
                  <button
                    type="button"
                    class="inline-block bg-primary-500 text-white rounded-md px-[31px] py-[11px] transition-all hover:bg-primary-400"
                  >
                    + Add Item
                  </button>
                </td>
              ...
              <tr>
                ...
                <td
                  class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l"
                >
                  <label class="mb-[10px] block"> Discount(%) </label>
                  <input
                    type="text"
                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-[200px] outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                    value="0.00"
                ...
                <td
                  class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l"
                >
                  <label class="mb-[10px] block"> Tax(%) </label>
                  <input
                    type="text"
                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-[200px] outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                    value="0.00"
        ...
        <div class="mt-[20px] md:mt-[25px] text-center">
          <button
            type="button"
            class="font-medium inline-block transition-all rounded-md md:text-md py-[10px] md:py-[12px] px-[20px] md:px-[22px] bg-danger-500 text-white hover:bg-danger-400 mx-[10px]"
          >
            Cancel
          </button>
          <button
            type="button"
            class="font-medium inline-block transition-all rounded-md md:text-md py-[10px] md:py-[12px] px-[20px] md:px-[22px] bg-primary-500 text-white hover:bg-primary-400 mx-[10px]"
          >
