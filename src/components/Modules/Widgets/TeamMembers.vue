        ...
        <table class="w-full">
          ...
          <tbody class="text-black dark:text-white">
              ...
              >
                <div class="flex items-center">
                  ...
                  <div class="ltr:ml-[12px] rtl:mr-[12px]">
                    <span class="font-medium inline-block"> Alex Davis </span>
            ...
            <tr>
              ...
              >
                <div
                  class="flex w-full h-[4px] overflow-hidden rounded-md bg-purple-50 dark:bg-[#172036]"
                >
                  <div
            ...
            <tr>
              ...
              >
                <div class="flex items-center">
                  ...
                  <div class="ltr:ml-[12px] rtl:mr-[12px]">
                    <span class="font-medium inline-block"> Rachel White </span>
                    <span class="block text-gray-500 dark:text-gray-400">
                      rachel@trezo.com
                    </span>
                  </div>
              ...
              >
                <div
                  class="flex w-full h-[4px] overflow-hidden rounded-md bg-danger-50 dark:bg-[#172036]"
                >
                  <div
                    class="flex flex-col justify-center overflow-hidden bg-danger-500 rounded-md"
                    style="width: 90%"
                  ></div>
                </div>
              </td>
            ...
            <tr>
              ...
              >
                <div class="flex items-center">
                  ...
                  <div class="ltr:ml-[12px] rtl:mr-[12px]">
                    <span class="font-medium inline-block"> Kevin Lee </span>
                    <span class="block text-gray-500 dark:text-gray-400">
                      kevin@trezo.com
                    </span>
                  </div>
              ...
              <td
                class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]"
              >
                <span class="text-gray-500 dark:text-gray-400"> 134 </span>
              </td>
              <td
                class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]"
              >
                <div
                  class="flex w-full h-[4px] overflow-hidden rounded-md bg-secondary-50 dark:bg-[#172036]"
                >
                  <div
                    class="flex flex-col justify-center overflow-hidden bg-secondary-500 rounded-md"
                    style="width: 50%"
                  ></div>
                </div>
              </td>
