  ...
  >
    ...
    >
      <div class="trezo-card-title">
        <h5 class="!mb-0">Image Size Square-Circle</h5>
      </div>
    </div>
    <div class="trezo-card-content">
      <div class="flex items-center gap-[15px]">
        <img
          src="@/assets/images/blue-man.jpg"
          alt="admin-image"
          class="rounded-md w-[130px] h-[130px]"
        />
        <img
          src="@/assets/images/blue-man.jpg"
          alt="admin-image"
          class="rounded-md w-[110px] h-[110px]"
        />
        <img
          src="@/assets/images/blue-man.jpg"
          alt="admin-image"
          class="rounded-md w-[90px] h-[90px]"
        />
        <img
          src="@/assets/images/blue-man.jpg"
          alt="admin-image"
          class="rounded-md w-[70px] h-[70px]"
        />
        <img
          src="@/assets/images/blue-man.jpg"
          alt="admin-image"
