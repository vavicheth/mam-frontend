  ...
  >
    ...
    <div class="trezo-card-content">
      <div class="flex items-center gap-[15px]">
        <div
          class="bg-[#f5f7f8] dark:bg-[#15203c] text-[25px] h-[130px] w-[130px] flex items-center justify-center text-primary-500 rounded-md text-center font-bold"
        >
          Ab
        </div>
        <div
          class="bg-[#f5f7f8] dark:bg-[#15203c] text-[20px] h-[110px] w-[110px] flex items-center justify-center text-primary-500 rounded-md text-center font-bold"
        >
          Ab
        </div>
        <div
          class="bg-[#f5f7f8] dark:bg-[#15203c] text-[18px] h-[90px] w-[90px] flex items-center justify-center text-primary-500 rounded-md text-center font-bold"
        >
          Ab
        </div>
        <div
          class="bg-[#f5f7f8] dark:bg-[#15203c] text-[16px] h-[70px] w-[70px] flex items-center justify-center text-primary-500 rounded-md text-center font-bold"
        >
          Ab
        </div>
        <div
          class="bg-[#f5f7f8] dark:bg-[#15203c] h-[45px] w-[45px] flex items-center justify-center text-primary-500 rounded-md text-center font-bold"
        >
          Ab
        </div>
      </div>
