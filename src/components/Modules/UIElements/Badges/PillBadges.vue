<template>
  ...
  &lt;/span&gt;
      ...
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-primary-500 bg-primary-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Primary
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-secondary-500 bg-secondary-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Secondary
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-success-500 bg-success-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Success
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-danger-500 bg-danger-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Danger
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-warning-500 bg-warning-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Warning
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-info-500 bg-info-500 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Info
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-dark border border-gray-50 bg-gray-50 text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Light
      </span>
      <span
        class="inline-block px-[15px] py-[.2em] text-white border border-dark bg-dark text-xs rounded-[100px] ltr:mr-[10px] rtl:ml-[10px] mb-[15px]"
      >
        Dark
      </span>
    </div>
