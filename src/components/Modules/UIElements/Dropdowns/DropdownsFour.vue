  ...
  >
    <div class="trezo-card-content">
      <div class="trezo-card-dropdown inline-block relative">
        <button
          :class="{
            'trezo-card-dropdown-btn inline-block py-[10px] px-[30px] bg-primary-500 text-white transition-all hover:bg-primary-400 rounded-md border border-primary-500 hover:border-primary-400': true,
            active: isActive,
          }"
          id="dropdownToggle"
        ...
        <ul
          class="trezo-card-dropdown-menu transition-all bg-white shadow-3xl rounded-md top-full py-[15px] absolute ltr:left-0 rtl:right-0 w-[195px] z-[5] dark:bg-dark dark:shadow-none"
        >
          <li>
            <button
              type="button"
