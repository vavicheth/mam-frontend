  ...
  >
    ...
    >
      <div class="trezo-card-title">
        <h5 class="!mb-0">Form Text</h5>
      </div>
    </div>
    <div class="trezo-card-content">
      <div class="mb-[20px] md:mb-[25px] last:mb-0">
        <label class="mb-[12px] font-medium block"> Password </label>
        <input
          type="password"
          class="h-[60px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
        />
